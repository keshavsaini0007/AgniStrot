...
export const ROLE_CONFIG: Record<UserRole, { label: string; description: string; color: string; bg: string }> = {
  // Backend vocabulary (live auth + user directory)
  mine_official: { label: 'Mine Official', description: 'Site operations management', color: '#4DA3FF', bg: 'rgba(77, 163, 255, 0.15)' },
  corporate_manager: { label: 'Corporate Manager', description: 'Corporate oversight', color: '#FF8C42', bg: 'rgba(255, 140, 66, 0.15)' },
  regulator: { label: 'Regulator', description: 'Regulatory compliance', color: '#22D3EE', bg: 'rgba(34, 211, 238, 0.15)' },
  field_officer: { label: 'Field Officer', description: 'Field capture', color: '#35C759', bg: 'rgba(53, 199, 89, 0.15)' },
  // Legacy demo roles (mock screens)
