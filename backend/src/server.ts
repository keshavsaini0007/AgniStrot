...
app.use(["/api/v1/exports", "/exports"], authenticate, exportRoutes);
app.use(["/api/v1/documents", "/documents"], authenticate, documentRoutes);
app.use(["/api/v1/evidence", "/evidence"], authenticate, evidenceRoutes);
app.use(["/api/v1/hazards", "/hazards"], authenticate, hazardRoutes);
