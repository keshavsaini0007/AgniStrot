    ...
    return (
      <div className="w-full">
        ...
        <div className="group relative">
          <select
            ref={ref}
            className={`w-full appearance-none rounded-xl border border-[#315064] bg-[#111F29]/70 px-4 py-2.5 pr-11 text-sm font-medium text-[#E8F0F3] shadow-[0_8px_24px_rgba(4,12,18,0.16)] outline-none transition-all duration-200 hover:border-[#527A91] hover:bg-[#172A36]/80 focus:border-[#D88A32] focus:ring-2 focus:ring-[#D88A32]/25 disabled:cursor-not-allowed disabled:opacity-50 ${
              error ? 'border-[#FF4D4F]' : ''
            } ${className}`}
            {...props}
          >
