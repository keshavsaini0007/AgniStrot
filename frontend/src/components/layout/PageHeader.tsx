...
export const PageHeader = ({ title, subtitle, action, backgroundImage = mineOperationsImg }: PageHeaderProps) => (
  <div className="relative isolate overflow-hidden rounded-2xl border border-[#25445B] bg-[#07121C] px-5 py-6 sm:px-7 sm:py-7">
    <img src={backgroundImage} alt="" className="absolute inset-0 -z-10 h-full w-full object-cover opacity-45" />
    <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,#07121C_4%,rgba(7,18,28,0.22)_46%,rgba(7,18,28,0.25)_100%)]" />
