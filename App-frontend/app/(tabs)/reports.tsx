  ...
  const renderViolationReport = () => {
    ...
    return (
      <Card style={styles.reportContent}>
        ...
        <View style={styles.kpiRow}>
          <KPICard title="Total Violations" value={observations.length} icon="alert" color={theme.danger} />
          <KPICard title="Critical" value={observations.filter((o) => o.severity === 'critical').length} icon="skull" color={theme.danger} />
          <KPICard title="High" value={observations.filter((o) => o.severity === 'high').length} icon="alert" color="#FF8C42" />
          <KPICard title="Actions Open" value={actions.filter((a) => a.status !== 'closed' && a.status !== 'resolved').length} icon="wrench" color={theme.warning} />
        </View>
        ...
        <Card style={styles.section}>
          ...
          {reportTypes.map((report) => {
            ...
            return (
              ...
              >
                <PngIcon name={report.icon} size={24} />
